  ...
  data={[
    ...
    },
    {
      ...
      desc: (
        <>
          Required <br />
          URL to return to after exiting the authorization server. This is the default
          returned redirectUrl (if the deviceType query param is not passed when
          requesting an authorization code). This can be the same value as either
          webRedirectUrl or mobileRedirectUrl
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      desc: (
        <>
          Required <br />
          Password must contain atleast 8 characters, one uppercase, one number and
